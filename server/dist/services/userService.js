...
exports.setupLoginSessionStorage = exports.setUpLocalAuthStrategy = exports.register = exports.getUserByUsername = exports.getUsersById = void 0;
...
const register = async (username, password) => {
    ...
    return new Promise((resolve, reject) => crypto_1.default.pbkdf2(password, salt, 310000, 32, 'sha256', async (err, hashedPassword) => {
        if (err) {
            reject(new Error("Unsuccessful registration - error creating credentials"));
        }
        await userData.addUser(username, hashedPassword, salt);
